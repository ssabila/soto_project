...
export default function Unity() {
  ...
  useEffect(() => {
    ...
    tl.to(
      text2Ref.current,
      { autoAlpha: 1, y: 0, duration: 1.4, ease: "back.out(1.7)" },
      "<0.5",
    )
      .to(
        bowls,
    ...
    tl.to(text3Ref.current, {
      ...
      .to(
        ings,
        {
          ...
          x: (i) =>
            ING_TARGETS[i % ING_TARGETS.length].x * gsap.utils.random(1.2, 1.6),
          y: (i) =>
            ING_TARGETS[i % ING_TARGETS.length].y * gsap.utils.random(1.2, 1.6),
          rotation: (i) =>
            ING_TARGETS[i % ING_TARGETS.length].r +
            gsap.utils.random(-200, 200),
          scale: (i) =>
            ING_TARGETS[i % ING_TARGETS.length].s * gsap.utils.random(0.9, 1.4),
      ...
      .to(
        [...bowls, ...ings],
        {
          x: (i) =>
            gsap.utils.wrap(
              [
                -400, 360, -320, 340, -280, 320, -380, 350, -250, 310, -190,
                290, -360, 380, -420, 370, -310, 350, -270, 330,
              ],
              i,
            ),
          y: (i) =>
            gsap.utils.wrap(
              [
                -300, -280, 300, 290, 100, -120, -260, 260, 80, -100, 320, -310,
                200, -200, -290, 270, 310, -300, 90, -110,
              ],
              i,
            ),
          rotation: (i) =>
            gsap.utils.wrap(
              [
                -35, 25, -45, 35, -20, 40, -160, 150, -90, 80, 120, -130, 55,
                -60, -40, 30, -50, 45, -25, 50,
              ],
              i,
            ),
          ease: "sine.inOut",
        ...
        {[...Array(5)].map((_, i) => (
          ...
          >
            <img
              src={globe}
              alt=""
              style={{ width: `${6 + i}vw`, maxWidth: "72px" }}
            />
          </div>
        ))}
        ...
        <div style={S.textCenter}>
          ...
          <h1
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, #c2410c 0%, #eab308 45%, #4d7c0f 100%)",
