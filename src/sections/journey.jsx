            ...
            >
              <div className="journey-content-wrapper" style={S.contentWrapper}>
                <div className="journey-card" style={S.card}>
                  ...
                  <div
                    className="j-frame journey-frame-container"
                    style={S.frameContainer}
                  >
...
const S = {
  ...
  card: {
    ...
    backgroundImage:
      "repeating-linear-gradient(45deg, rgba(255,233,195,0.45) 0, rgba(255,233,195,0.45) 6px, rgba(255,242,214,0.45) 6px, rgba(255,242,214,0.45) 12px)",
